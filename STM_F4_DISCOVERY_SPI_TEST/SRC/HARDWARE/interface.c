...
//      GpioInit_USART1_RX_OFF();
      GpioIniM_USART1_TX(hd_gptp_IN_OD);
      GpioIniM_USART1_RX(hd_gptp_IN_OD);
      break;
    case interface_GPIO_ON:       //ON
      ...
      GpioInAM_USART1_TX(hd_gptp_AF_PP,  GPIO_AF_USART1);
      GpioInAM_USART1_RX(hd_gptp_AF_PP,  GPIO_AF_USART1);
      break;
    case interface_GPIO_TX_OFF:     //HOLD ENABLE
      GpioIniM_USART1_TX(hd_gptp_IN_PPU);//GpioInit_USART1_TX_OFF();
      break;
    case interface_GPIO_TX_ON:      //HOLD DISABLE
      GpioIniM_USART1_TX(hd_gptp_AF_PP);//GpioInit_USART1_TX_ON();
      break;
    case interface_GPIO_TX_0:
      //GpioAFCF_USART1_TX(GPIO_AF_EVENTOUT);
      //USART1_TX(0);
      USART_SendBreak(USART1);
      break;
    case interface_GPIO_TX_1:
      GpioIniM_USART1_TX(hd_gptp_OUT_PP);
      USART1_TX(1);
      break;
...
interface_USART_MacroFunctionGenerator(RS,USART1,256,256);
