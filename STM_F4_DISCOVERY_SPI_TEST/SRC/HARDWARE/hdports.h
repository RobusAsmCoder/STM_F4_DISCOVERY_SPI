...
static __forceinline void GpioIniM_##_name(u16 md)          { hdGPIO_Setup((GPIO_TypeDef *)_name##wp_port, _name##wp_pin, md, _def); }                        \
static __forceinline void GpioInit_##_name(void)            { GpioIniM_##_name(_name##wp_mode); }                                                             \
static __forceinline void GpioAFCF_##_name(u8 val)          { GPIO_PinAFConfig((GPIO_TypeDef *)_name##wp_port, GPIO_PinSource##_pin, val); }                  \
static __forceinline void GpioInAM_##_name(u16 md, u8 val)  { GpioIniM_##_name(md); GpioAFCF_##_name(val);  }                                                 \
