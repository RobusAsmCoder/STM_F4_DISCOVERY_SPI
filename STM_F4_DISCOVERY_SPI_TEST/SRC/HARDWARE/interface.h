...
enum {
  ...
  interface_GPIO_TX_0     = 6,
  interface_GPIO_TX_1     = 7,
};
...
//hdPin_O_DefineSetup(USART1_TX,      A,  9, hd_gptp_AF_PP,     1);
//hdPin_O_DefineSetup(USART1_RX,      A, 10, hd_gptp_AF_PP,     1);
hdPin_O_DefineSetup(USART1_TX,      B,  6, hd_gptp_AF_PP,     1);
#define USART1_TX(_v)               dH_PORT_WritV(USART1_TX,_v)
hdPin_O_DefineSetup(USART1_RX,      B,  7, hd_gptp_AF_PP,     1);
//hdPin_O_DefineSetup(USART1_TX_ON,      A,  9, hd_gptp_AF_PP,     1);
